...
function LoginContent() {
  ...
  useEffect(() => {
    ...
    // Check for authentication errors in URL - only on client side
    ...
    // Check session - only on client side
    if (typeof window !== 'undefined') {
      ...
      // Get available providers - only on client side
        ...
        <div className="w-full max-w-md">
          ...
          <div className="backdrop-blur-xl bg-white/[0.08] border border-white/20 rounded-3xl p-8 shadow-2xl hover:shadow-purple-500/10 transition-all duration-500">
            ...
            <div className="space-y-6">
              ...
              {errorMessage && (
                <div className="bg-red-500/20 border border-red-400/50 rounded-2xl p-4 mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="text-red-400 text-xl">⚠️</div>
                    <div>
                      <h4 className="text-red-200 font-semibold text-sm">Authentication Error</h4>
              ...
              {!hasGoogleProvider && !isLoading && (
                <div className="bg-blue-500/20 border border-blue-400/50 rounded-2xl p-4 mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="text-blue-400 text-xl">ℹ️</div>
                    <div>
                      <h4 className="text-blue-200 font-semibold text-sm">OAuth Setup Required</h4>
              ...
              >
                ...
                {isLoading ? (
                  ...
                  <div className="relative flex items-center">
                    <svg className="w-6 h-6 mr-4 opacity-50" viewBox="0 0 24 24">
                    ...
                    <span className="text-lg opacity-50">OAuth Not Configured</span>
                  </div>
                ) : (
                  <div className="relative flex items-center">
