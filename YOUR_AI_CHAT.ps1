...
$BackendUrl = "https://deploy-rescue-13.preview.emergentagent.com:8001/api"
...
try {
    $healthUrl = "https://deploy-rescue-13.preview.emergentagent.com:8001/api/health"
    ...
    try {
        $healthUrl = "https://deploy-rescue-13.preview.emergentagent.com/api/health"
        $BackendUrl = "https://deploy-rescue-13.preview.emergentagent.com/api"
        $healthResponse = Invoke-RestMethod -Uri $healthUrl -Method Get -TimeoutSec 15
        Write-Host "[SUCCESS] ✅ Connected to AI team!" -ForegroundColor Green
    }
    catch {
        ...
        Write-Host "  - https://deploy-rescue-13.preview.emergentagent.com:8001/api/health" -ForegroundColor Gray
        Write-Host "  - https://deploy-rescue-13.preview.emergentagent.com/api/health" -ForegroundColor Gray
