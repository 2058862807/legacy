  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        <div className="text-center">
          <h2 className="text-2xl font-bold">NextEra Estate - Access</h2>
          <p className="mt-4 text-gray-600">Click below to access your dashboard immediately</p>
        </div>
        
        <button
          onClick={handleBypass}
          className="w-full bg-green-600 text-white py-3 px-4 rounded-lg font-semibold text-lg hover:bg-green-700"
        >
          ACCESS DASHBOARD - NO LOGIN REQUIRED
        </button>
        
        <p className="text-center text-sm text-gray-500">
          Bypassing login issues - direct access to your $100 investment
        </p>
      </div>
    </div>
  );
