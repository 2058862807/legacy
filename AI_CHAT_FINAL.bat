...
set URL1=https://estate-planner-5.preview.emergentagent.com/api/8001
set URL2=https://estate-planner-5.preview.emergentagent.com:8001/api  
set URL3=https://estate-planner-5.preview.emergentagent.com/api
set BACKEND_URL=
...
echo.
echo Your frontend URL: https://estate-planner-5.preview.emergentagent.com/
echo Expected backend URL patterns:
echo   - https://estate-planner-5.preview.emergentagent.com:8001/api
echo   - https://estate-planner-5.preview.emergentagent.com/api  
echo   - https://estate-planner-5.preview.emergentagent.com/api/8001
echo.
pause
exit /b 1
