  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl max-w-5xl max-h-[90vh] overflow-hidden">
        ...
        {/* Optional Full Document Review - Collapsible */}
        <div className="border-t border-gray-200">
          <button
            onClick={() => setCurrentTab(currentTab === 'collapsed' ? 'terms' : 'collapsed')}
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-gray-700">
                {currentTab === 'collapsed' ? 'Click to Review Full Legal Documents (Optional)' : 'Hide Full Documents'}
              </span>
            </div>
            <svg 
              className={`w-5 h-5 text-gray-400 transform transition-transform ${
                currentTab === 'collapsed' ? 'rotate-0' : 'rotate-180'
              }`} 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
