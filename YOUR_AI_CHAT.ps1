...
$BackendUrl = "https://estate-planner-4.preview.emergentagent.com:8001/api"
...
try {
    $healthUrl = "https://estate-planner-4.preview.emergentagent.com:8001/api/health"
    ...
    try {
        $healthUrl = "https://estate-planner-4.preview.emergentagent.com/api/health"
        $BackendUrl = "https://estate-planner-4.preview.emergentagent.com/api"
        $healthResponse = Invoke-RestMethod -Uri $healthUrl -Method Get -TimeoutSec 15
        Write-Host "[SUCCESS] ✅ Connected to AI team!" -ForegroundColor Green
    }
    catch {
        ...
        Write-Host "  - https://estate-planner-4.preview.emergentagent.com:8001/api/health" -ForegroundColor Gray
        Write-Host "  - https://estate-planner-4.preview.emergentagent.com/api/health" -ForegroundColor Gray
