...
Optional provider imports, guarded so startup never crashes
...
DNS helper, keep a safe fallback

try:
from providers.dns_client import set_a_record # adjust to your actual module if different
except Exception:
...
Remove static mounting. Frontend runs on Vercel.
