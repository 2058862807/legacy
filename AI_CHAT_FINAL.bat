...
set URL1=https://estate-api-bridge.preview.emergentagent.com/api/8001
set URL2=https://estate-api-bridge.preview.emergentagent.com:8001/api  
set URL3=https://estate-api-bridge.preview.emergentagent.com/api
set BACKEND_URL=
...
echo.
echo Your frontend URL: https://estate-api-bridge.preview.emergentagent.com/
echo Expected backend URL patterns:
echo   - https://estate-api-bridge.preview.emergentagent.com:8001/api
echo   - https://estate-api-bridge.preview.emergentagent.com/api  
echo   - https://estate-api-bridge.preview.emergentagent.com/api/8001
echo.
pause
exit /b 1
