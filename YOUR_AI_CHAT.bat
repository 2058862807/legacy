...
set BACKEND_URL=https://estate-genius-1.preview.emergentagent.com:8001/api
...
if errorlevel 1 (
    ...
    set BACKEND_URL=https://estate-genius-1.preview.emergentagent.com/api/8001
    curl -s "https://estate-genius-1.preview.emergentagent.com/api/health" -o nul --connect-timeout 10
    if errorlevel 1 (
