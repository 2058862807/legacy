...
set URL1=https://nextera-estate-fix.preview.emergentagent.com/api/8001
set URL2=https://nextera-estate-fix.preview.emergentagent.com:8001/api  
set URL3=https://nextera-estate-fix.preview.emergentagent.com/api
set BACKEND_URL=
...
echo.
echo Your frontend URL: https://nextera-estate-fix.preview.emergentagent.com/
echo Expected backend URL patterns:
echo   - https://nextera-estate-fix.preview.emergentagent.com:8001/api
echo   - https://nextera-estate-fix.preview.emergentagent.com/api  
echo   - https://nextera-estate-fix.preview.emergentagent.com/api/8001
echo.
pause
exit /b 1
